...
class DatabaseProvider {
  ...
  async runMigrationSQLite (dbName) {
    const migrationSqlPath = path.resolve(__dirname, '../migrations/sqlite/db_migration_sqlite_v1.0.6.sql')
    const migrationVersion = '1.0.6'
  ...
  async runMigrationMySQL (db) {
    const migrationSqlPath = path.resolve(__dirname, '../migrations/mysql/db_migration_mysql_v1.0.6.sql')
    const migrationVersion = '1.0.6'
  ...
  async runMigrationPostgres (db) {
    const migrationSqlPath = path.resolve(__dirname, '../migrations/postgres/db_migration_pg_v1.0.6.sql')
    const migrationVersion = '1.0.6'
